...
const GIF = {
  ...
  lunge:        'https://raw.githubusercontent.com/laycielee/WorkoutGIFs/main/split-squat-exercise-illustration.gif',
  gluteBridge:  'https://raw.githubusercontent.com/laycielee/WorkoutGIFs/main/glute-bridge-exercise-illustration-spotebi.gif', 
  calfRaise:    'https://raw.githubusercontent.com/laycielee/WorkoutGIFs/main/squat-exercise-illustration.gif', 
  jumpSquat:    'https://raw.githubusercontent.com/laycielee/WorkoutGIFs/main/sumo-squat-exercise-illustration-spotebi.gif', 
  ...
  burpee:       'https://raw.githubusercontent.com/laycielee/WorkoutGIFs/main/cross-jacks-exercise-illustration-spotebi.gif', 
  mountainClimber: 'https://raw.githubusercontent.com/laycielee/WorkoutGIFs/main/run-in-place-exercise-illustration.gif', 
  ...
  backExt:      'https://raw.githubusercontent.com/laycielee/WorkoutGIFs/main/bent-over-twist-exercise-illustration.gif', 
  tricepDip:    'https://raw.githubusercontent.com/laycielee/WorkoutGIFs/main/hindu-push-ups-exercise-illustration-spotebi.gif', 
  armCircle:    'https://raw.githubusercontent.com/laycielee/WorkoutGIFs/main/arm-circles-exercise-illustration.gif',
  pikePushUp:   'https://raw.githubusercontent.com/laycielee/WorkoutGIFs/main/hindu-push-ups-exercise-illustration-spotebi.gif', 
  shoulderTap:  'https://raw.githubusercontent.com/laycielee/WorkoutGIFs/main/plank-exercise-illustration.gif', 
  sidePlank:    'https://raw.githubusercontent.com/laycielee/WorkoutGIFs/main/plank-exercise-illustration.gif',
};
...
const DB = {
  'TOÀN THÂN': {
    'BEGINNER': [
      ...
      { name: 'Hít đất đầu gối', type: 'reps', dur: 8, gif: GIF.pushUpWide },
      ...
      { name: 'Chạm gót chân', type: 'reps', dur: 15, gif: GIF.crunch },
      { name: 'Nâng chân cao', type: 'time', dur: 20, gif: GIF.legRaise },
      { name: 'Gập bụng cơ bản', type: 'reps', dur: 12, gif: GIF.crunch },
      { name: 'Plank giữ cơ', type: 'time', dur: 20, gif: GIF.plank },
      { name: 'Chạm gót chân', type: 'reps', dur: 15, gif: GIF.crunch },
      ...
      { name: 'Gập bụng chéo', type: 'reps', dur: 10, gif: GIF.crunch },
      { name: 'Plank nghiêng trái', type: 'time', dur: 15, gif: GIF.sidePlank },
      { name: 'Nâng hông', type: 'reps', dur: 12, gif: GIF.gluteBridge },
      { name: 'Mountain Climbers', type: 'time', dur: 20, gif: GIF.mountainClimber },
    ],
    'INTERMEDIATE': [
      { name: 'Gập bụng chữ V', type: 'reps', dur: 15, gif: GIF.crunch },
      ...
      { name: 'Chạm gót chân', type: 'reps', dur: 20, gif: GIF.crunch },
      { name: 'Plank lên xuống', type: 'time', dur: 30, gif: GIF.plank },
      { name: 'Gập bụng ngược', type: 'reps', dur: 15, gif: GIF.legRaise },
    ],
    'ADVANCED': [
      { name: 'Gập bụng chữ V nâng cao', type: 'reps', dur: 20, gif: GIF.crunch },
      ...
      { name: 'Chạm gót liên tục', type: 'reps', dur: 30, gif: GIF.crunch },
      { name: 'Gập bụng ngược nâng cao', type: 'reps', dur: 20, gif: GIF.legRaise },
    ],
  },
  'NGỰC': {
    'BEGINNER': [
      ...
      { name: 'Hít đất rộng tay', type: 'reps', dur: 8, gif: GIF.pushUp },
      { name: 'Plank giữ cơ', type: 'time', dur: 20, gif: GIF.plank },
    ...
    'INTERMEDIATE': [
      ...
      { name: 'Hít đất rộng tay', type: 'reps', dur: 12, gif: GIF.pushUp },
    ...
    'ADVANCED': [
      ...
      { name: 'Hít đất rộng tay sâu', type: 'reps', dur: 15, gif: GIF.pushUp },
      { name: 'Plank giữ cơ lâu', type: 'time', dur: 60, gif: GIF.plank },
